...
INSERT INTO user (user_first_name, user_last_name, user_email, user_password, user_role_id)
...
INSERT INTO subproject (project_id, subproject_name, subproject_priority, subproject_deadline, subproject_completed)
VALUES (1, 'create', 2, '2023-06-10', 0),
       (1, 'test', 5, '2023-10-30', 0),
       (2, 'init', 1, current_date(), 2);

INSERT INTO task (subproject_id, task_name, task_description, task_priority, task_duration, task_deadline,
                  task_completed, task_manager_name)
VALUES (1, 'methods', 'Create methods for this task', 3, 2, current_date(), 0, "Thomas Løvkilde"),
