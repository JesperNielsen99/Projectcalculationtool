...
COPY SQL/productionDatabase/* /docker-entrypoint-initdb.d/
...
# Build like this:
# docker build  -t projectcalculationtool .

# Run like this:
# docker run -it --rm --name projectcalculationtool --pid=host -p 8080:8080 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=root projectcalculationtool
#
...
#   - `--name projectcalculationtool`: This sets the name of the container to "projectcalculationtool".
...
#   - `projectcalculationtool`: This specifies the name of the image to run.